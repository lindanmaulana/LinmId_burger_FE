...
import {
  ServicePaymentsUpdate,
  ServicePaymentsUpdateData,
...
const ViewDashboardPayments = () => {
  ...
  const { mutate } = useMutation({
    ...
    mutationFn: (data: ServicePaymentsUpdateData) =>
      ServicePaymentsUpdate(data),
  });
  ...
  return (
    <PageDataLayout title="Payments">
      ...
      />
      <SConfirmationModal
        confirm={() => handlePayment({ id: idPayment, status: status })}
